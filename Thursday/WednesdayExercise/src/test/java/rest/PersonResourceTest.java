...
public class PersonResourceTest {
    ...
    public void testGetAllPersons() throws Exception {
        given()
                ...
                .assertThat()
                .statusCode(HttpStatus.OK_200.getStatusCode())
                .body("firstname", hasItems("Amalie", "Laura", "Amanda", "Jonas"),
                        "lastname", hasItems("Landt", "Saxtrup", "Hansen", "Haslund"));
    }
    ...
    public void testAddPerson() throws Exception {
        ...
        given()
                ...
                .assertThat()
                .statusCode(HttpStatus.OK_200.getStatusCode())
                .body("firstname", equalTo("Benjamin"), "lastname", equalTo("Kongshaug"), "phone", equalTo("12345678"));
    }
    ...
    public void testEditPerson() throws Exception {
        ...
        given()
                ...
                .assertThat()
                .statusCode(HttpStatus.OK_200.getStatusCode())
                .body("firstname", equalTo("Charlotte"), "lastname", equalTo("Saxtrup"), "phone", equalTo("20141614"));
    }
    ...
    public void testEditPersonError() {
        ...
        given()
                ...
                .assertThat()
                .statusCode(HttpStatus.NOT_FOUND_404.getStatusCode())
                .body("code", equalTo(404), "message", equalTo("Could not edit, provided id does not exist"));
    ...
    public void testDeletePerson() throws Exception {
        given()
                ...
                .assertThat()
                .statusCode(HttpStatus.OK_200.getStatusCode())
                .body("firstname", equalTo("Amanda"), "lastname", equalTo("Hansen"), "phone", equalTo("42441486"));
    }
    ...
    public void testDeletePersonError() {
        given()
                .contentType("application/json")
                .delete("/person/" + 140).then()
                .assertThat()
                .statusCode(HttpStatus.NOT_FOUND_404.getStatusCode())
                .body("code", equalTo(404), "message", equalTo("Could not delete, provided id does not exist"));
